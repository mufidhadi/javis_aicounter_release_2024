...
function hitung_smp(data={jumlah:{sm:0.0,mp:0.0,ks:0.0,bb:0.0,tb:0.0},jenis_jalan:'perkotaan'}) {
    // ambil dari emp.json
    fetch('emp.json')
...
function hitung_smp_perkotaan(sm=0.0,mp=0.0,ks=0.0,bb=0.0,tb=0.0,tipe_jalan='2/2-tt',c_0=1800) {
...
function hitung_smp_simpang_apill(sm=0.0,mp=0.0,ks=0.0,bb=0.0,tb=0.0,tipe_pendekat='terlindung') {
...
module.exports = {hitung_smp, hitung_smp_perkotaan, hitung_smp_simpang_apill}