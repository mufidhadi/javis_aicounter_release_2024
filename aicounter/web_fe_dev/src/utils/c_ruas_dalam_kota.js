...
function nilai_c_0(tipe_jalan) {
    ...
    return (tabel_c_0[tipe_jalan] == undefined) ? 1700 : tabel_c_0[tipe_jalan];
}

function nilai_fc_lj(tipe_jalan, l_le) {
    let fc_lj = 0.0;
    let key_l_le = parseFloat(l_le).toFixed(2);
    ...
    return (fc_lj === undefined) ? 1.0 : fc_lj;
}
...
function nilai_fc_pa(pa) {
    ...
    return (tabel_fc_pa[pa] === undefined) ? 1.0 : tabel_fc_pa[pa];
}
...
function nilai_fc_hs(tipe_jalan, khs, lebar_bahu_efektif, berbahu_berkereb = 'berbahu') {
    ...
    return (fc_hs === undefined) ? 1.0 : fc_hs;
}
...
function nilai_fc_uk(ukuran_kota) {
    ...
    return (tabel_fc_uk[key_ukuran_kota]===undefined) ? 1.0 : tabel_fc_uk[key_ukuran_kota];
}
